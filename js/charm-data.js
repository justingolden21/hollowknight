const CHARMS = {
	'Wayward_Compass': {
		...
		description_short: 'Whispers its location to the bearer whenever a map is open.',
		effects: [
	...
	'Gathering_Swarm': {
		...
		description_short: 'A swarm will follow the bearer and gather up any loose Geo.',
		effects: [
	...
	'Stalwart_Shell': {
		...
		description_short: 'When recovering from damage, the bearer will remain invulnerable for longer.',
		effects: [
	...
	'Soul_Catcher': {
		...
		description_short: 'Increases the amount of SOUL gained when striking an enemy with the nail.',
		effects: [
	...
	'Shaman_Stone': {
		...
		description_short: 'Increases the power of spells, dealing more damage to foes.',
		effects: [
	...
	'Soul_Eater': {
		...
		description_short: 'Greatly increases the amount of SOUL gained when striking an enemy with the nail.',
		effects: [
	...
	'Dashmaster': {
		...
		description_short: 'The bearer will be able to dash more often as well as dash downwards.',
		effects: [
	...
	'Sprintmaster': {
		...
		description_short: 'Increases the running speed of the bearer, allowing them to avoid danger or overtake rivals.',
		effects: [
	...
	'Grubberfly\'s_Elegy': {
		...
		description_short: 'Imbues weapons with a holy strength. When the bearer is at full health, they will fire beams of white-hot energy from their nail.',
		effects: [
	...
	'Fragile_Heart': {
		...
		description_short: 'Increases the health of the bearer. This charm is fragile, and will break if its bearer is killed.',
		effects: [
	...
	'Fragile_Greed': {
		...
		description_short: 'Causes the bearer to find more Geo when defeating enemies. This charm is fragile, and will break if its bearer is killed.',
		effects: [
	...
	'Fragile_Strength': {
		...
		description_short: 'Strengthens the bearer, increasing the damage they deal to enemies with their nail. This charm is fragile, and will break if its bearer is killed.',
		effects: [
	...
	'Steady_Body': {
		...
		description_short: 'Keeps its bearer from recoiling backwards when they strike an enemy with a nail.',
		effects: [
	...
	'Heavy_Blow': {
		...
		description_short: 'Increases the force of the bearer\'s nail, causing enemies to recoil further when hit.',
		effects: [
	...
	'Quick_Slash': {
		...
		description_short: 'Allows the bearer to slash much more rapidly with their nail.',
		effects: [
	...
	'Fury_of_the_Fallen': {
		...
		description_short: 'When close to death, the bearer\'s strength will increase.',
		effects: [
	...
	'Thorns_of_Agony': {
		...
		description_short: 'When taking damage, sprout thorny vines that damage nearby foes.',
		effects: [
	...
	'Baldur_Shell': {
		...
		description_short: 'Protects its bearer with a hard shell while focusing SOUL.',
		effects: [
	...
	'Flukenest': {
		...
		description_short: 'Transforms the Vengeful Spirit spell into a horde of volatile baby flukes.',
		effects: [
	...
	'Glowing_Womb': {
		...
		description_short: 'Drains the SOUL of its bearer and uses it to birth hatchlings.',
		effects: [
	...
	'Quick_Focus': {
		...
		description_short: 'Increases the speed of focusing SOUL, allowing the bearer to heal faster.',
		effects: [
	...
	'Deep_Focus': {
		...
		description_short: 'The bearer will focus SOUL at a slower rate, but the healing effect will double.',
		effects: [
	...
	'Lifeblood_Heart': {
		...
		description_short: 'When resting, the bearer will gain a coating of lifeblood that protects from a modest amount of damage.',
		effects: [
	...
	'Lifeblood_Core': {
		...
		description_short: 'When resting, the bearer will gain a coating of lifeblood that protects from a large amount of damage.',
		effects: [
	...
	'Joni\'s_Blessing': {
		...
		description_short: 'The bearer will have a healthier shell and can take more damage, but they will not be able to heal themselves by focusing SOUL.',
		effects: [
	...
	'Hiveblood': {
		...
		description_short: 'Heals the bearer\'s wounds over time, allowing them to regain health without focusing SOUL.',
		effects: [
	...
	'Spore_Shroom': {
		...
		description_short: 'When focusing SOUL, emit a spore cloud that slowly damages enemies.',
		effects: [
	...
	'Sharp_Shadow': {
		...
		description_short: 'When using Shadow Dash, the bearer\'s body will sharpen and damage enemies.',
		effects: [
	...
	'Shape_of_Unn': {
		...
		description_short: 'While focusing SOUL, the bearer will take on a new shape and can move freely to avoid enemies.',
		effects: [
	...
	'Nailmaster\'s_Glory': {
		...
		description_short: 'Increases the bearer\'s mastery of Nail Arts, allowing them to focus their power faster and unleash arts sooner.',
		effects: [
	...
	'Weaversong': {
		...
		description_short: 'Summons weaverlings to give the lonely bearer some companionship and protection.',
		effects: [
	...
	'Dream_Wielder': {
		...
		description_short: 'Allows the bearer to charge the Dream Nail faster and collect more SOUL when striking foes.',
		effects: [
	...
	'Dreamshield': {
		...
		description_short: 'Conjures a shield that follows the bearer and attempts to protect them.',
		effects: [
	...
	'Grimmchild': {
		...
		description_short: 'Worn by those who take part in the Grimm Troupe\'s Ritual. The bearer must seek the Grimmkin and collect their flames. Uncollected flames will appear on the bearer\'s map.',
		effects: [
	...
	'Kingsoul': {
		...
		description_short: 'Holy charm symbolising a union between higher beings. The bearer will slowly absorb the limitless SOUL contained within. Opens the way to a birthplace.',
		effects: [
	...
	'Carefree_Melody': {
		...
		description_short: 'Contains a song of protection that may defend the bearer from damage.',
		effects: [
	...
	'Void_Heart': {
		...
		description_short: 'Unifies the void under the bearer\'s will. This charm is a part of its bearer and can not be unequipped.',
		effects: [
			'Unlocks 4 endings',
