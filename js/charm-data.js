const CHARMS = {
	Wayward_Compass: {
		...
		acquisition:
			'Bought from Iselda in Dirtmouth for 220 Geo, after the first encounter with Cornifer the cartographer.',
		category: 'movement',
	},
	Gathering_Swarm: {
		notches: 1,
		...
		location: 'Dirtmouth',
		description:
			"A swarm will follow the bearer and gather up any loose Geo.<hr>Useful for those who can't bear to leave anything behind, no matter how insignificant.",
		description_short:
	...
	Stalwart_Shell: {
		...
		location: 'Dirtmouth',
		description:
			'Builds resilience. When recovering from damage, the bearer will remain invulnerable for longer.<hr>Makes it easier to escape from dangerous situations.',
		description_short:
	...
	Soul_Catcher: {
		...
		description:
			'Used by shamans to draw more SOUL from the world around them.<hr>Increases the amount of SOUL gained when striking an enemy with the nail.',
		description_short:
	...
	Shaman_Stone: {
		...
		location: 'Forgotten Crossroads',
		description:
			'Said to contain the knowledge of past generations of shaman.<hr>Increases the power of spells, dealing more damage to foes.',
		description_short:
	...
	Soul_Eater: {
		...
		description:
			'Forgotten shaman artifact, used to draw SOUL from still-living creatures.<hr>Greatly increases the amount of SOUL gained when striking an enemy with the nail.',
		description_short:
	...
	Dashmaster: {
		...
		description:
			"Bears the likeness of an eccentric bug known only as 'The Dashmaster'.<hr>The bearer will be able to dash more often as well as dash downwards. Perfect for those who want to move around as quickly as possible.",
		description_short:
	...
	Sprintmaster: {
		...
		location: 'Dirtmouth',
		description:
			"Bears the likeness of a strange bug known only as 'The Sprintmaster'.<hr>Increases the running speed of the bearer, allowing them to avoid danger or overtake rivals.",
		description_short:
		...
		acquisition:
			"Bought from Sly in Dirtmouth after acquiring the Shopkeeper's Key for 400 Geo. Requires Grimm Troupe content pack.",
		category: 'movement',
	},
	Grubsong: {
		notches: 1,
		...
		location: 'Forgotten Crossroads',
		description:
			'Contains the gratitude of freed grubs.<hr>Gain SOUL when taking damage.',
		description_short: 'Gain SOUL when taking damage.',
	...
	"Grubberfly's_Elegy": {
		...
		location: 'Forgotten Crossroads',
		description:
			'Contains the gratitude of grubs who will move to the next stage of their lives. Imbues weapons with a holy strength.<hr>When the bearer is at full health, they will fire beams of white-hot energy from their nail.',
		description_short:
	...
	Fragile_Heart: {
		...
		location: 'Fungal Wastes',
		description:
			'Increases the health of the bearer, allowing them to take more damage.<hr>This charm is fragile, and will break if its bearer is killed.',
		description_short:
		...
		acquisition:
			"Purchased from Leg Eater in Fungal Wastes for 350 Geo. Wearing the Defender's Crest will cause Leg Eater to lower the cost to 280 Geo.<br>When broken, Leg Eater can repair it for 200 Geo, or for 160 Geo while wearing the Defender's Crest.",
		acquisition2:
			'Once the Knight has summoned the Grimm Troupe, Divine becomes accessible in Dirtmouth. To get the unbreakable version of Fragile Heart, the player must equip it then when speaking to her, give it to her when prompted. She will eat the charm, then ask for 12000 Geo. Once the Geo is paid, she gives the player the unbreakable version of the Fragile Heart charm.',
		category: 'defense',
	},
	Fragile_Greed: {
		notches: 2,
	...
	Spell_Twister: {
		...
		description:
			"Reflecting the desires of the Soul Sanctum for mastery over SOUL, it improves the bearer's ability to cast spells.<hr>Reduces the SOUL cost of casting spells.",
		description_short: 'Reduces the SOUL cost of casting spells.',
	...
	Steady_Body: {
		...
		location: 'Forgotten Crossroads',
		description:
			'Keeps its bearer from recoiling backwards when they strike an enemy with a nail.<hr>Allows one to stay steady and keep attacking.',
		description_short:
		...
		acquisition:
			'Bought from Salubra for 120 Geo in the Forgotten Crossroads.',
	...
	Heavy_Blow: {
		...
		location: 'Dirtmouth',
		description:
			"Formed from the nails of fallen warriors.<hr>Increases the force of the bearer's nail, causing enemies to recoil further when hit.",
		description_short:
		...
		acquisition:
			"Bought from Sly for 350 Geo after bringing him the Shopkeeper's Key found in the Crystal Peak.",
	...
	Quick_Slash: {
		...
		description:
			'Born from imperfect, discarded nails that have fused together. The nails still long to be wielded.<hr>Allows the bearer to slash much more rapidly with their nail.',
		description_short:
	...
	Longnail: {
		...
		description_short: "Increases the range of the bearer's nail.",
		effects: ['Increases nail range by 15%'],
		acquisition:
			'Bought from Salubra in the Forgotten Crossroads for 300 Geo.',
		category: 'attack defense',
	},
	Mark_of_Pride: {
		notches: 3,
		...
		description:
			"Freely given by the Mantis Tribe to those they respect.<hr>Greatly increases the range of the bearer's nail, allowing them to strike foes from further away.",
		description_short: "Greatly increases the range of the bearer's nail.",
	...
	Fury_of_the_Fallen: {
		...
		description:
			"Embodies the fury and heroism that comes upon those who are about to die.<hr>When close to death, the bearer's strength will increase.",
		description_short:
	...
	Baldur_Shell: {
		...
		description:
			'Protects its bearer with a hard shell while focusing SOUL.<hr>The shell is not indestructible and will shatter if it absorbs too much damage.',
		description_short:
		...
		acquisition:
			'This charm is located in the southwest portion of the Howling Cliffs, where there is a chest that drops only 1 Geo. Jumping down into the chest takes the Knight to a cave guarded by two Elder Baldurs. Defeating the one on the right opens a tunnel filled with Elder Baldur corpses that leads to the charm.',
	...
	Flukenest: {
		...
		description:
			'Living charm born in the gut of a Flukemarm.<hr>Transforms the Vengeful Spirit and Shade Soul spells into a horde of volatile baby flukes.',
		description_short:
	...
	"Defender's_Crest": {
		...
		location: 'Royal Waterways',
		description:
			'Unique charm bestowed by the King of Hallownest to his most loyal knight. Scratched and dirty, but still cared for.<hr>Causes the bearer to emit a heroic odour.',
		description_short: 'Causes the bearer to emit a heroic odour.',
		effects: [
	...
	Glowing_Womb: {
		...
		location: 'Forgotten Crossroads',
		description:
			'Drains the SOUL of its bearer and uses it to birth hatchlings.<hr>The hatchlings have no desire to eat or live, and will sacrifice themselves to protect their parent.',
		description_short:
	...
	Deep_Focus: {
		...
		description:
			'Naturally formed within a crystal over a long period. Draws in SOUL from the surrounding air.<hr>The bearer will focus SOUL at a slower rate, but the healing effect will double.',
		description_short:
		...
		acquisition:
			'Found in Crystal Peak in a hidden cave made entirely of crystals.<br>Below the area where Cornifer can be found, look for a Husk Miner mining a wall. Break the wall to reveal the secret area. Requires Crystal Heart.',
		category: 'soul',
	},
	Lifeblood_Heart: {
		notches: 2,
	...
	Lifeblood_Core: {
		...
		location: 'The Abyss',
		description:
			'Contains a living core that bleeds precious lifeblood.<hr>When resting, the bearer will gain a coating of lifeblood that protects from a large amount of damage.',
		description_short:
	...
	"Joni's_Blessing": {
		...
		location: 'Howling Cliffs',
		description:
			'Blessed by Joni, the kindly heretic. Transfigures vital fluids into blue lifeblood.<hr>The bearer will have a healthier shell and can take more damage, but they will not be able to heal themselves by focusing SOUL.',
		description_short:
	...
	Hiveblood: {
		...
		location: 'The Hive',
		description:
			"Golden nugget of the Hive's precious hardened nectar.<hr>Heals the bearer's wounds over time, allowing them to regain health without focusing SOUL.",
		description_short:
	...
	Spore_Shroom: {
		...
		location: 'Fungal Wastes',
		description:
			'Composed of living fungal matter. Scatters spores when exposed to SOUL.<hr>When focusing SOUL, emit a spore cloud that slowly damages enemies.',
		description_short:
	...
	Sharp_Shadow: {
		...
		location: 'Deepnest',
		description:
			"Contains a forbidden spell that transforms shadows into deadly weapons.<hr>When using Shadow Dash, the bearer's body will sharpen and damage enemies.",
		description_short:
	...
	Shape_of_Unn: {
		...
		location: 'Greenpath',
		description:
			'Reveals the form of Unn within the bearer.<hr>While focusing SOUL, the bearer will take on a new shape and can move freely to avoid enemies.',
		description_short:
			'While focusing SOUL, the bearer will take on a new shape and can move freely to avoid enemies.',
		effects: ['Allows moving while focusing'],
		acquisition:
	...
	"Nailmaster's_Glory": {
		...
		location: 'Dirtmouth',
		description:
			"Contains the passion, skill and regrets of a Nailmaster.<hr>Increases the bearer's mastery of Nail Arts, allowing them to focus their power faster and unleash arts sooner.",
		description_short:
	...
	Weaversong: {
		...
		location: 'Deepnest',
		description:
			'Silken charm containing a song of farewell, left by the Weavers who departed Hallownest for their old home.<hr>Summons weaverlings to give the lonely bearer some companionship and protection.',
		description_short:
	...
	Dream_Wielder: {
		...
		location: 'Resting Grounds',
		description:
			'Transient charm created for those who wield the Dream Nail and collect Essence.<hr>Allows the bearer to charge the Dream Nail faster and collect more SOUL when striking foes.',
		description_short:
	...
	Dreamshield: {
		...
		location: 'Resting Grounds',
		description:
			'Defensive charm once wielded by a tribe that could shape dreams.<hr>Conjures a shield that follows the bearer and attempts to protect them.',
		description_short:
		...
		acquisition:
			"Found in a room in Resting Grounds, below the Seer's room. Requires Grimm Troupe content pack.",
	...
	Kingsoul: {
		...
		description:
			'Holy charm symbolising a union between higher beings. The bearer will slowly absorb the limitless SOUL contained within.<br>Opens the way to a birthplace.',
		description_short:
	...
	Carefree_Melody: {
		...
		location: 'Dirtmouth',
		description:
			'Token commemorating the start of a friendship.<hr>Contains a song of protection that may defend the bearer from damage.',
		description_short:
		...
		acquisition:
			'After banishing the Grimm Troupe, the charm can be acquired from Nymm by talking to him in Dirtmouth. Requires Grimm Troupe content pack.',
		category: 'defense',
	},
	Void_Heart: {
		notches: 0,
		...
		location: 'The Abyss',
		description:
			"An emptiness that was hidden within, now unconstrained. Unifies the void under the bearer's will.<hr>This charm is a part of its bearer and can not be unequipped.",
		description_short:
